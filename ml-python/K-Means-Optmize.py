...
# Calcular as distâncias euclidianas entre cada usuário e sua antena otimizada
distances = np.linalg.norm(user_locations - antenna_positions_after[kmeans.labels_], axis=1)

# Adicionar a coluna "Distância" na tabela de posições
user_positions_df['Distância'] = distances
